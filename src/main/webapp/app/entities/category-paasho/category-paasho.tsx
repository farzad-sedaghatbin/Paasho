...
import { getSearchEntities, getEntities } from './category-paasho.reducer';
import { ICategoryPaasho } from 'app/shared/model/category-paasho.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface ICategoryPaashoProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface ICategoryPaashoState {
  search: string;
}

export class CategoryPaasho extends React.Component<ICategoryPaashoProps, ICategoryPaashoState> {
  state: ICategoryPaashoState = {
    search: ''
  };
