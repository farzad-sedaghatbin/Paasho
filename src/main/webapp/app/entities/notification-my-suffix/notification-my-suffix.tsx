...
import { getSearchEntities, getEntities } from './notification-my-suffix.reducer';
import { INotificationMySuffix } from 'app/shared/model/notification-my-suffix.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface INotificationMySuffixProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface INotificationMySuffixState {
  search: string;
}

export class NotificationMySuffix extends React.Component<INotificationMySuffixProps, INotificationMySuffixState> {
  state: INotificationMySuffixState = {
    search: ''
  };
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="notification-my-suffix-heading">
          Notifications
