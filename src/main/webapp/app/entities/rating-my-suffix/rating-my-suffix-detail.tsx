...
export interface IRatingMySuffixDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export class RatingMySuffixDetail extends React.Component<IRatingMySuffixDetailProps> {
  componentDidMount() {
      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            ...
            <dt>Id</dt>
            <dd>{ratingEntity.idId ? ratingEntity.idId : ''}</dd>
          </dl>
          <Button tag={Link} to="/entity/rating-my-suffix" replace color="info">
            <FontAwesomeIcon icon="arrow-left" /> <span className="d-none d-md-inline">Back</span>
          </Button>&nbsp;
          <Button tag={Link} to={`/entity/rating-my-suffix/${ratingEntity.id}/edit`} replace color="primary">
