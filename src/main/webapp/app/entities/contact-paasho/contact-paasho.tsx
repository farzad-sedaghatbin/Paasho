...
import { getSearchEntities, getEntities } from './contact-paasho.reducer';
import { IContactPaasho } from 'app/shared/model/contact-paasho.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IContactPaashoProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface IContactPaashoState {
  search: string;
}

export class ContactPaasho extends React.Component<IContactPaashoProps, IContactPaashoState> {
  state: IContactPaashoState = {
    search: ''
  };
