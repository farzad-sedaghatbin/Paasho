...
import { getEntity, updateEntity, createEntity, reset } from './factor-my-suffix.reducer';
import { IFactorMySuffix } from 'app/shared/model/factor-my-suffix.model';
// tslint:disable-next-line:no-unused-variable
import { convertDateTimeFromServer, convertDateTimeToServer } from 'app/shared/util/date-utils';
import { mapIdList } from 'app/shared/util/entity-utils';

export interface IFactorMySuffixUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export interface IFactorMySuffixUpdateState {
  isNew: boolean;
  eventId: string;
  userId: string;
}

export class FactorMySuffixUpdate extends React.Component<IFactorMySuffixUpdateProps, IFactorMySuffixUpdateState> {
  constructor(props) {
    super(props);
    this.state = {
      eventId: '0',
  ...
  handleClose = () => {
    this.props.history.push('/entity/factor-my-suffix');
  };
              ...
              <AvForm model={isNew ? {} : factorEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    ...
                    <AvInput id="factor-my-suffix-id" type="text" className="form-control" name="id" required readOnly />
                  </AvGroup>
                ) : null}
                <AvGroup>
                  ...
                  <AvField id="factor-my-suffix-price" type="text" name="price" />
                </AvGroup>
                <AvGroup>
                  <Label id="codeLabel" for="code">
                    Code
                  </Label>
                  <AvField id="factor-my-suffix-code" type="text" name="code" />
                </AvGroup>
                <AvGroup>
                  <Label id="statusLabel">Status</Label>
                  <AvInput
                    id="factor-my-suffix-status"
                    type="select"
                ...
                <AvGroup>
                  ...
                  <AvInput
                    id="factor-my-suffix-completeDate"
                    type="datetime-local"
                    className="form-control"
                    name="completeDate"
                ...
                <AvGroup>
                  ...
                  <AvInput id="factor-my-suffix-event" type="select" className="form-control" name="eventId">
                    <option value="" key="0" />
                    {events
                ...
                <AvGroup>
                  ...
                  <AvInput id="factor-my-suffix-user" type="select" className="form-control" name="userId">
                    <option value="" key="0" />
                    {user1S
                ...
                <Button tag={Link} id="cancel-save" to="/entity/factor-my-suffix" replace color="info">
