...
import { getEntity } from './factor-my-suffix.reducer';
import { IFactorMySuffix } from 'app/shared/model/factor-my-suffix.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IFactorMySuffixDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export class FactorMySuffixDetail extends React.Component<IFactorMySuffixDetailProps> {
  componentDidMount() {
    ...
    return (
      <Row>
        <Col md="8">
          ...
          <Button tag={Link} to="/entity/factor-my-suffix" replace color="info">
            <FontAwesomeIcon icon="arrow-left" /> <span className="d-none d-md-inline">Back</span>
          </Button>&nbsp;
          <Button tag={Link} to={`/entity/factor-my-suffix/${factorEntity.id}/edit`} replace color="primary">
