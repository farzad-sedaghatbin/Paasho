...
import { getSearchEntities, getEntities } from './category-my-suffix.reducer';
...
export interface ICategoryMySuffixState {
  search: string;
}

export class CategoryMySuffix extends React.Component<ICategoryMySuffixProps, ICategoryMySuffixState> {
  state: ICategoryMySuffixState = {
    search: ''
  };
