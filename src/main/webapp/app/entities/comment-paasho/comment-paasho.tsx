...
import { getSearchEntities, getEntities } from './comment-paasho.reducer';
import { ICommentPaasho } from 'app/shared/model/comment-paasho.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface ICommentPaashoProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface ICommentPaashoState {
  search: string;
}

export class CommentPaasho extends React.Component<ICommentPaashoProps, ICommentPaashoState> {
  state: ICommentPaashoState = {
    search: ''
  };
