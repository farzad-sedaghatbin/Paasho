...
import { getSearchEntities, getEntities } from './media-my-suffix.reducer';
import { IMediaMySuffix } from 'app/shared/model/media-my-suffix.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IMediaMySuffixProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface IMediaMySuffixState {
  search: string;
}

export class MediaMySuffix extends React.Component<IMediaMySuffixProps, IMediaMySuffixState> {
  state: IMediaMySuffixState = {
    search: ''
  };
