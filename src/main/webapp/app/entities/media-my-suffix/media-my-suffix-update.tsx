...
export interface IMediaMySuffixUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}
...
export class MediaMySuffixUpdate extends React.Component<IMediaMySuffixUpdateProps, IMediaMySuffixUpdateState> {
  ...
  handleClose = () => {
    this.props.history.push('/entity/media-my-suffix');
  };
              ...
              <AvForm model={isNew ? {} : mediaEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    ...
                    <AvInput id="media-my-suffix-id" type="text" className="form-control" name="id" required readOnly />
                  </AvGroup>
                ) : null}
                <AvGroup>
                  ...
                  <AvField id="media-my-suffix-path" type="text" name="path" />
                </AvGroup>
                <AvGroup>
                  <Label id="typeLabel">Type</Label>
                  <AvInput
                    id="media-my-suffix-type"
                    type="select"
                ...
                <AvGroup>
                  ...
                  <AvInput id="media-my-suffix-id" type="select" className="form-control" name="idId">
                    <option value="" key="0" />
                    {events
                ...
                <Button tag={Link} id="cancel-save" to="/entity/media-my-suffix" replace color="info">
