...
import { getSearchEntities, getEntities } from './notification-paasho.reducer';
import { INotificationPaasho } from 'app/shared/model/notification-paasho.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface INotificationPaashoProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface INotificationPaashoState {
  search: string;
}

export class NotificationPaasho extends React.Component<INotificationPaashoProps, INotificationPaashoState> {
  state: INotificationPaashoState = {
    search: ''
  };
