...
public class JalaliCalendar {
    ...
    public static void main(String[] args) {
        ...
        String dateString="1368/04/02";
        String[] s = dateString.split("/");
        System.out.println(ZonedDateTime.ofInstant(new JalaliCalendar(Integer.valueOf(s[0]),Integer.valueOf(s[1]),Integer.valueOf(s[2])).toGregorian().toInstant(), ZoneId.systemDefault()));
        System.out.println(new JalaliCalendar(1368,04,02).toGregorian().toInstant());
        System.out.println(   new JalaliCalendar(new GregorianCalendar(2019, 0, 1)));
        System.out.println(new Date(new JalaliCalendar(1368,03,02).toGregorian().toInstant().toEpochMilli()));
    }
