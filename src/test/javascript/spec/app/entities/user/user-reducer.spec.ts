...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes(
        [REQUEST(ACTION_TYPES.FETCH_USER_LIST), REQUEST(ACTION_TYPES.SEARCH_USERS), REQUEST(ACTION_TYPES.FETCH_USER)],
        {},
        state => {
          expect(state).toMatchObject({
            errorMessage: null,
  ...
  describe('Failures', () => {
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          FAILURE(ACTION_TYPES.FETCH_USER_LIST),
          FAILURE(ACTION_TYPES.SEARCH_USERS),
  ...
  describe('Successes', () => {
    it('should fetch all entities', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_USER_LIST),
          payload
        })
      ).toEqual({
        ...initialState,
    ...
    it('should search all entities', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.SEARCH_USERS),
          payload
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_USER_LIST actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_USER_LIST)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_USER_LIST),
    ...
    it('dispatches ACTION_TYPES.SEARCH_USERS actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.SEARCH_USERS)
        },
        {
          type: SUCCESS(ACTION_TYPES.SEARCH_USERS),
          payload: resolvedObject
    ...
    it('dispatches ACTION_TYPES.FETCH_USER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches ACTION_TYPES.CREATE_USER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches ACTION_TYPES.UPDATE_USER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches ACTION_TYPES.DELETE_USER actions', async () => {
      const expectedActions = [
        {
